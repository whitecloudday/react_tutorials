...
const HeroSection = () => {
  return (
    <div className='hero-wrapper flex flex-col items-center mt-6'>
      ...
      <p className='mt-10 text-lg text-center text-neutral-500 max-w-4xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Est eveniet laborum pariatur ut, voluptate rem eius iste dignissimos? Sint illo consequuntur tenetur deserunt voluptatum veritatis. Voluptatibus mollitia consectetur quibusdam aliquam</p>
